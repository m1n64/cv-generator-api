# Variables
SERVICES = shared-network user-service cv-service information-service templates-service generator-service ai-service gateway-service healthcheck-service
