...
pub mod health_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn check(
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("health.HealthService", "Check"));
        ...
        pub async fn watch(
            ...
            tonic::Response<tonic::codec::Streaming<super::CheckResponse>>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("health.HealthService", "Watch"));
...
pub mod health_service_server {
    ...
    pub trait HealthService: std::marker::Send + std::marker::Sync + 'static {
        ...
        type WatchStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<super::CheckResponse, tonic::Status>,
            >
            + std::marker::Send
            + 'static;
        async fn watch(
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/health.HealthService/Watch" => {
                    ...
                    impl<
                        T: HealthService,
                    > tonic::server::ServerStreamingService<super::CheckRequest>
                    for WatchSvc<T> {
                        type Response = super::CheckResponse;
    ...
    pub const SERVICE_NAME: &str = "health.HealthService";
