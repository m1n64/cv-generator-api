...
type HealthServiceClient interface {
	...
	Watch(ctx context.Context, in *CheckRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[CheckResponse], error)
}
...
func (c *healthServiceClient) Watch(ctx context.Context, in *CheckRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[CheckResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type HealthService_WatchClient = grpc.ServerStreamingClient[CheckResponse]
...
type HealthServiceServer interface {
	...
	Watch(*CheckRequest, grpc.ServerStreamingServer[CheckResponse]) error
...
func (UnimplementedHealthServiceServer) Watch(*CheckRequest, grpc.ServerStreamingServer[CheckResponse]) error {
...
func _HealthService_Watch_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(HealthServiceServer).Watch(m, &grpc.GenericServerStream[CheckRequest, CheckResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type HealthService_WatchServer = grpc.ServerStreamingServer[CheckResponse]
